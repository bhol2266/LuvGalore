...
<title>{`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos - LuvGalore | ${currentPageNumberURL}`}</title>
...
<meta property="og:title" content={`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos - LuvGalore`} />
...
<meta name="twitter:title" content={`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos - LuvGalore`} />
...
<link rel="canonical" href={`https://www.LuvGalore.com/pornstar/${code}/${pornstarname}/page/${page}`} />
