...
function Index({ video_collection, pages, pornstarInformation, collageImages }) {
    ...
    return (
        <>
           <Head>
                <title>{`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos - LuvGalore`}</title>
                ...
                <link rel="canonical" href={`https://www.LuvGalore.com/pornstar/${code}/${pornstarname}`} />
            </Head>
