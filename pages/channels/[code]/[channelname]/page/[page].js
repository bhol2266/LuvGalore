    ...
    return (
        <>
            ...
            <Head>
                ...
                <title>{`Free ${capitalizeFirstLetter(channel_name.replace('+', " ").replace("+", " "))} Porn Videos - LuvGalore | ${currentPageNumberURL}`}</title>
                ...
                <meta name="twitter:title" content={`${capitalizeFirstLetter(channel_name.replace('+', " ").replace("+", " "))} Porn Videos - LuvGalore`} />
                ...
                <link rel="canonical" href={`https://www.LuvGalore.com/channels/${code}/${channelname}/page/${page}`} />
